...
AARCH64_OBJS = obj/aarch64_start.o obj/aarch64_kernel.o obj/aarch64_uart_pl011.o obj/aarch64_arch.o obj/aarch64_fdt.o obj/aarch64_vectors.o obj/aarch64_gicv2.o obj/aarch64_timer.o obj/aarch64_irq.o obj/aarch64_timer_tick.o obj/aarch64_exception.o obj/aarch64_psci.o obj/aarch64_smp.o obj/aarch64_fb_simple.o obj/aarch64_gfx.o obj/aarch64_gfx_backend_fb_simple.o obj/aarch64_printf.o obj/aarch64_string.o obj/aarch64_shell_log_stub.o obj/aarch64_heap.o obj/aarch64_hal_console.o obj/aarch64_hal_time.o obj/aarch64_hal_irq.o obj/aarch64_shell_state.o obj/aarch64_shell_caps.o obj/aarch64_compat_stubs.o obj/aarch64_util_globals.o

# Full-mode links an alternative entry and uses the shared shell core.
AARCH64_FULL_OBJS = obj/aarch64_start.o obj/aarch64_kernel_full.o obj/aarch64_shell_meminfo.o obj/aarch64_shell.o obj/aarch64_history.o obj/aarch64_putchar.o obj/aarch64_shell_commands.o obj/aarch64_fs_commands.o obj/aarch64_fs_io_helpers.o obj/aarch64_uart_pl011.o obj/aarch64_virtio_input.o obj/aarch64_virtio_blk.o obj/aarch64_ata_virtio.o obj/aarch64_arch.o obj/aarch64_fdt.o obj/aarch64_vectors.o obj/aarch64_gicv2.o obj/aarch64_timer.o obj/aarch64_irq.o obj/aarch64_timer_tick.o obj/aarch64_exception.o obj/aarch64_psci.o obj/aarch64_smp.o obj/aarch64_fb_simple.o obj/aarch64_gfx.o obj/aarch64_gfx_backend_fb_simple.o obj/aarch64_printf.o obj/aarch64_string.o obj/aarch64_shell_log.o obj/aarch64_heap.o obj/aarch64_pipeline.o obj/aarch64_predictive_memory.o obj/aarch64_zero_copy.o obj/aarch64_shell_caps.o obj/aarch64_compat_stubs.o obj/aarch64_vga.o obj/aarch64_multiboot_compat.o obj/aarch64_mouse.o obj/aarch64_watchdog_stub.o obj/aarch64_tui.o obj/aarch64_help_tui.o obj/aarch64_terminals.o obj/aarch64_tiling_manager.o obj/aarch64_ui_prefs.o obj/aarch64_tiling_cmd.o obj/aarch64_theme_cmd.o obj/aarch64_draw_gui.o obj/aarch64_image_viewer_gui.o obj/aarch64_stats_gui.o obj/aarch64_window_test.o obj/aarch64_rei.o obj/aarch64_reiv.o obj/aarch64_fs_stubs.o obj/aarch64_alias.o obj/aarch64_math.o obj/aarch64_fat32.o obj/aarch64_eynfs.o obj/aarch64_partition.o obj/aarch64_vfs.o obj/aarch64_hal_console.o obj/aarch64_hal_keyboard.o obj/aarch64_gfx_cmd.o obj/aarch64_shell_state.o obj/aarch64_util_globals.o obj/aarch64_linux_syscalls.o obj/aarch64_kernel_api.o obj/aarch64_sched.o obj/aarch64_native_exec.o obj/aarch64_hal_time.o obj/aarch64_hal_irq.o
...
obj/aarch64_shell_log_stub.o:src/utilities/aarch64/shell_log.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/aarch64/shell_log.c -o obj/aarch64_shell_log_stub.o

obj/aarch64_shell_log.o:src/utilities/shell/shell_log.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/shell_log.c -o obj/aarch64_shell_log.o
...
obj/aarch64_shell_caps.o:src/utilities/shell/shell_caps.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/shell_caps.c -o obj/aarch64_shell_caps.o

obj/aarch64_compat_stubs.o:src/entry/aarch64/compat_stubs.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/entry/aarch64/compat_stubs.c -o obj/aarch64_compat_stubs.o
...
obj/aarch64_cmd_registry_portable.o:src/utilities/shell/command_registry_portable.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/command_registry_portable.c -o obj/aarch64_cmd_registry_portable.o

obj/aarch64_putchar.o:src/utilities/aarch64/putchar.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/aarch64/putchar.c -o obj/aarch64_putchar.o

obj/aarch64_shell_commands.o:src/utilities/shell/shell_commands.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/shell_commands.c -o obj/aarch64_shell_commands.o

obj/aarch64_fs_commands.o:src/utilities/shell/fs_commands.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/fs_commands.c -o obj/aarch64_fs_commands.o

obj/aarch64_fs_io_helpers.o:src/utilities/shell/fs_io_helpers.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/fs_io_helpers.c -o obj/aarch64_fs_io_helpers.o
...
obj/aarch64_vga.o:src/drivers/aarch64/vga.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/drivers/aarch64/vga.c -o obj/aarch64_vga.o

obj/aarch64_multiboot_compat.o:src/entry/aarch64/multiboot_compat.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/entry/aarch64/multiboot_compat.c -o obj/aarch64_multiboot_compat.o

obj/aarch64_mouse.o:src/drivers/aarch64/mouse_stub.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/drivers/aarch64/mouse_stub.c -o obj/aarch64_mouse.o

obj/aarch64_watchdog_stub.o:src/misc/aarch64/watchdog_stub.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/misc/aarch64/watchdog_stub.c -o obj/aarch64_watchdog_stub.o

obj/aarch64_tui.o:src/utilities/tui/tui.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/tui/tui.c -o obj/aarch64_tui.o

obj/aarch64_help_tui.o:src/utilities/shell/help_tui.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/help_tui.c -o obj/aarch64_help_tui.o

obj/aarch64_terminals.o:src/utilities/tui/terminals.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/tui/terminals.c -o obj/aarch64_terminals.o

obj/aarch64_tiling_manager.o:src/utilities/tui/tiling_manager.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/tui/tiling_manager.c -o obj/aarch64_tiling_manager.o

obj/aarch64_ui_prefs.o:src/utilities/tui/ui_prefs.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/tui/ui_prefs.c -o obj/aarch64_ui_prefs.o

obj/aarch64_tiling_cmd.o:src/utilities/shell/tiling_cmd.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/tiling_cmd.c -o obj/aarch64_tiling_cmd.o

obj/aarch64_theme_cmd.o:src/utilities/shell/theme_cmd.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/theme_cmd.c -o obj/aarch64_theme_cmd.o

obj/aarch64_draw_gui.o:src/utilities/shell/draw_gui.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/draw_gui.c -o obj/aarch64_draw_gui.o

obj/aarch64_image_viewer_gui.o:src/utilities/shell/image_viewer_gui.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/image_viewer_gui.c -o obj/aarch64_image_viewer_gui.o

obj/aarch64_stats_gui.o:src/utilities/shell/stats_gui.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/stats_gui.c -o obj/aarch64_stats_gui.o

obj/aarch64_window_test.o:src/utilities/shell/window_test.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/shell/window_test.c -o obj/aarch64_window_test.o

obj/aarch64_rei.o:src/drivers/rei.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/drivers/rei.c -o obj/aarch64_rei.o

obj/aarch64_reiv.o:src/drivers/reiv.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/drivers/reiv.c -o obj/aarch64_reiv.o
...
obj/aarch64_shell_meminfo.o:src/entry/aarch64/shell_meminfo.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/entry/aarch64/shell_meminfo.c -o obj/aarch64_shell_meminfo.o
...
obj/aarch64_partition.o:src/drivers/partition.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/drivers/partition.c -o obj/aarch64_partition.o

obj/aarch64_predictive_memory.o:src/utilities/predictive_memory.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/predictive_memory.c -o obj/aarch64_predictive_memory.o

obj/aarch64_zero_copy.o:src/utilities/zero_copy.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/zero_copy.c -o obj/aarch64_zero_copy.o

obj/aarch64_kernel_api.o:src/cpu/kernel_api.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/cpu/kernel_api.c -o obj/aarch64_kernel_api.o

obj/aarch64_sched.o:src/cpu/sched.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/cpu/sched.c -o obj/aarch64_sched.o

obj/aarch64_native_exec.o:src/cpu/native_exec.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/cpu/native_exec.c -o obj/aarch64_native_exec.o

obj/aarch64_vfs.o:src/fs/vfs.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/fs/vfs.c -o obj/aarch64_vfs.o

obj/aarch64_linux_syscalls.o:src/cpu/linux_syscalls.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/cpu/linux_syscalls.c -o obj/aarch64_linux_syscalls.o
...
obj/shell_log.o:src/utilities/shell/shell_log.c
	$(COMPILER) $(CFLAGS) src/utilities/shell/shell_log.c -o obj/shell_log.o
...
obj/shell_caps.o:src/utilities/shell/shell_caps.c
	$(COMPILER) $(CFLAGS) src/utilities/shell/shell_caps.c -o obj/shell_caps.o

obj/fs_commands.o:src/utilities/shell/fs_commands.c
	$(COMPILER) $(CFLAGS) src/utilities/shell/fs_commands.c -o obj/fs_commands.o

obj/fs_io_helpers.o:src/utilities/shell/fs_io_helpers.c
	$(COMPILER) $(CFLAGS) src/utilities/shell/fs_io_helpers.c -o obj/fs_io_helpers.o
