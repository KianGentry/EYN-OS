...
obj/aarch64_shell_log.o:src/utilities/aarch64/shell_log.c $(AARCH64_PLATFORM_STAMP)
	mkdir obj/ -p
	$(AARCH64_CC) $(AARCH64_CFLAGS) src/utilities/aarch64/shell_log.c -o obj/aarch64_shell_log.o
